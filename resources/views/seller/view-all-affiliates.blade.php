            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> View All Affiliates</h2>
                        <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/sellers/dashboard') }}"><i class="fa fa-money"></i></a></li>                                  
                            ...
                            <li class="breadcrumb-item active">View All Affiliates</li>
                        </ul>
                    </div>
                            ...
                            <table id="data-table" class="table table-bordered table-striped table-hover dataTable js-exportable" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th rowspan="1" colspan="1">Total Commission</th>
                                            <th rowspan="1" colspan="1">Number of Order</th>
                                            <th rowspan="1" colspan="1">Amount Owed</th>
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="odd">
                                        <td class="sorting_1">johndoe123</td>
                                        <td>$500</td>
                                        <td>10</td>
                                        <td>$100</td>
                                        <td>$400</td>
                                    ...
                                    <tr role="row" class="odd">
                                        <td class="sorting_1">rodger-harper</td>
                                        <td>$300</td>
                                        <td>5</td>
                                        <td>$50</td>
                                        <td>$250</td>
