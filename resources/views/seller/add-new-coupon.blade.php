                                ...
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <form action="">
                                        <div class="form-group">
                                            ...
                                            <select name="payment_method" class="form-control show-tick ms select2" data-placeholder="Select a product" >
                                                <option></option>
                                                <option>PHP</option>
                                                <option>JS</option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="" placeholder="e.g. CHRISTMAS50PERCENTOFF">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" class="form-control" placeholder="Disount value" aria-describedby="basic-addon2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="datepicker-here form-control" data-timepicker="true" data-time-format='hh:ii aa'  name="" placeholder="Expiry date">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Number of Uses <span class="text-danger">*</span></label>
                                            <input type="number"  class="form-control" value="-1" name="" placeholder="Number of uses">
                                        </div>
