            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">                        
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Feedback</h2>
                        <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/sellers/dashboard.php') }}"><i class="fa fa-money"></i></a></li>                              
                            ...
                            <table id="data-table" class="table table-bordered table-striped table-hover dataTable js-exportable" id="DataTables_Table_1" role="grid" aria-describedby="DataTables_Table_1_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th rowspan="1" colspan="1">Your Response</th>
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="even">
                                        ...
                                        <td>2008/11/28</td>
                                        <td>
                                            <a href="#" class="btn btn-sm btn-info" title="Approve"><i class="fa fa-check"></i></a>
                                    ...
                                    <tr role="row" class="even">
                                        <td class="sorting_1">
                                            ...
                                            <span class="text-warning"><i class="fa fa-star"></i></span>
                                            <span class="text-warning"><i class="fa fa-star"></i></span>
                                            <span class="text-light"><i class="fa fa-star"></i></span>
                                            <span class="text-light"><i class="fa fa-star"></i></span>
                                        </td>
                                        <td>Awesome Book!</td>
                                        <td>Thanks for the feedback.</td>
